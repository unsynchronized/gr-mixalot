...
# Description: pager mux
# Generated: Tue May 21 11:41:34 2019
##################################################
...
class pagermux(gr.top_block):
    ...
    def __init__(self, capcode=425321, message='GRAND CENTRAL\\x0a\\x0aHACKRF THE PLANET'):
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c((1,0,1,0), True, 1, [])
        self.blocks_socket_pdu_0 = blocks.socket_pdu("TCP_SERVER", '127.0.0.1', '31337', 10000, False)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_gr_complex*1)
        self.blocks_multiply_matrix_xx_0 = blocks.multiply_matrix_cc(((0,1), (0, 1)), gr.TPP_ALL_TO_ALL)
        ...
        self.connect((self.blocks_multiply_matrix_xx_0, 1), (self.blocks_null_sink_0, 0))
        self.connect((self.blocks_multiply_matrix_xx_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_multiply_matrix_xx_0, 0))
        ...
        self.connect((self.pfb_arb_resampler_xxx_0, 0), (self.blocks_multiply_matrix_xx_0, 1))
...
def main(top_block_cls=pagermux, options=None):
    if options is None:
